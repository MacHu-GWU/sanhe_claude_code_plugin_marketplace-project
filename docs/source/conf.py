# -*- coding: utf-8 -*-
#
# sanhe_claude_code_plugin_marketplace documentation build configuration file, created by
...
package_name = "sanhe_claude_code_plugin_marketplace"
...
# Add data for Jinja2
try:
    from sanhe_claude_code_plugin_marketplace.docs import doc_data
except:
    doc_data = dict()
